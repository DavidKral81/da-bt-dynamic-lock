...
--------------------------------------------
The build tools sit in `_android-build` (~700 MB), a folder next to the
project folder, meant to be deleted once it is no longer needed. The key
does not belong there - it belongs to the project.
